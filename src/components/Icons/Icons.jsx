...
export const HomeIcon = ({ w = 30, h = 29, color = "#000" }) => {
  return (
    <svg width={w} height={h} viewBox="0 0 30 29" fill="none">
      <path
        d="M28.5873 12.632L28.5851 12.6298L16.8697 0.915974C16.3703 0.416441 15.7064 0.141479 15.0002 0.141479C14.294 0.141479 13.63 0.416441 13.1305 0.915974L1.42115 12.6239C1.41721 12.6278 1.41304 12.632 1.40932 12.6359C0.38386 13.6672 0.385613 15.3404 1.41436 16.3691C1.88436 16.8392 2.5049 17.1113 3.1686 17.14C3.19577 17.1427 3.22294 17.144 3.25033 17.144H3.71704V25.7644C3.71704 27.4705 5.10536 28.8585 6.81161 28.8585H11.3951C11.8598 28.8585 12.2365 28.4816 12.2365 28.0171V21.2586C12.2365 20.4801 14.2216 19.8469 15.0002 19.8469C15.7787 19.8469 17.7636 20.4801 17.7636 21.2586V28.0171C17.7636 28.4816 18.1403 28.8585 18.6051 28.8585H23.1885C24.895 28.8585 26.2831 27.4705 26.2831 25.7644V17.144H26.716C27.422 17.144 28.0859 16.869 28.5858 16.3693C29.6156 15.3391 29.616 13.6628 28.5873 12.632Z"
        fill={color}
      />
    </svg>
  );
